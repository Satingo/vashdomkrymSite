...
<div class="form min-fancy-width <?php echo (isset($isFancy) && $isFancy) ? 'white-popup-block' : ''; ?>">
	<h2 class="title highlight-left-right">
		<span><?php echo tt("Message for the listing's owner №", 'notifier'). ' '. CHtml::link($apartment->id, $apartment->getUrl()); ?></span>
	</h2>
	...
	<div class="form">
		...
		<div class="row buttons">
			<?php echo CHtml::submitButton(tt('send_request', 'apartments'), array('class' => 'button-blue')); ?>
		</div>
