<div class="title highlight-left-right">
	<span><h1><?php echo tt('Contact Us', 'contactform'); ?></h1></span>
</div>
...
?>
		...
		<div class="row">
			...
			$this->widget('CustomCCaptcha',
				array(
					...
					'clickableImage' => true,
					'imageOptions'=>array('id'=>'contact-form_captcha'),
				)
			);?>
			<br/>
		</div>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton(tt('Send message', 'contactform'), array('class' => 'button-blue')); ?>
	</div>
