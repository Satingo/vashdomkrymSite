<div class="<?php echo $divClass; ?>">
	...
	<?php } 
		...
		<div class="<?php echo $controlClass; ?>">
			<input onblur="changeSearch();" type="number" id="floorMin" name="floor_min" class="width120 search-input-new" placeholder="<?php echo tc('Floor from') ?>" value="<?php echo CHtml::encode($floorMin); ?>"/>&nbsp;
			<input onblur="changeSearch();" type="number" id="floorMax" name="floor_max" class="width120 search-input-new" placeholder="<?php echo tc('Floor to') ?>" value="<?php echo CHtml::encode($floorMax); ?>"/>&nbsp;
		</div>
