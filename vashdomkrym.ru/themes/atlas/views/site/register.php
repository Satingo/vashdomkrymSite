...
<h1 class="title highlight-left-right">
	<span><?php echo Yii::t('common', 'Join now'); ?></span>
</h1>
...
<div class="form">
	...
	<div class="row">
		...
		<?php echo $form->telField($model,'phone',array('size'=>20,'maxlength'=>15,'class'=>'width200')); ?>
	...
	<div class="row submit">
		<?php echo CHtml::submitButton(Yii::t('common', 'Registration'), array('class' => 'button-blue')); ?>
	</div>
