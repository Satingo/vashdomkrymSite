<?php if ($video) :?>
	<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/js/flowplayer/flowplayer-3.2.12.min.js', CClientScript::POS_END); ?>
	...
	<?php if (file_exists($fileFolder)) : ?>
		...
		<?php
			Yii::app()->clientScript->registerScript('player-'.$id.'', '
				flowplayer("player-'.$id.'", "'.Yii::app()->theme->baseUrl."/js/flowplayer/flowplayer-3.2.16.swf".'",
				{
					clip: {
						autoPlay: false
					}
